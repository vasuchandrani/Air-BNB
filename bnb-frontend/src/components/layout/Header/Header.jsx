...
import { SearchIcon, GlobeIcon, HamburgerIcon } from '../../../assets/icons';
import ArchitectureModal from '../../modals/ArchitectureModal/ArchitectureModal';
import './Header.css';
      ...
      <header className="header">
        <div className="header__container container">
          ...
          <a href="/" className="header__logo" aria-label="Airbnb homepage">
            <svg viewBox="0 0 320.1 99.9" xmlns="http://www.w3.org/2000/svg" height="32" width="102" fill="#FF385C">
          ...
          <div className="header__search">
            <button className="header__search-btn" type="button" aria-label="Search">
              <img src="/images/house_icon.png" alt="" className="header__search-house-icon" />
              <span className="header__search-text header__search-text--bold">Anywhere</span>
              <span className="header__search-divider" />
              <span className="header__search-text header__search-text--bold">Anytime</span>
              <span className="header__search-divider" />
              <span className="header__search-text header__search-text--light">Add guests</span>
          ...
          <div className="header__right">
            <a href="#" className="header__host-link" onClick={(e) => e.preventDefault()}>Become a host</a>
            <button className="header__circle-btn" type="button" aria-label="Language & region">
              <GlobeIcon size={16} />
            </button>
